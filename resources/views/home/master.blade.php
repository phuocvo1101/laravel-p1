...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('home/images/flavicon.png') }}" />
    ...
    /* <![CDATA[ */
    var google_conversion_id = 874970302;
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/874970302/?value=0&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
    <!-- /Google tracking -->
  </head>
