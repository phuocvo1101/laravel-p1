...
<head>
    ...
    <!-- CKEditor && CKFinder -->
    <script src="<?php echo e(url('admin/js/ckeditor/ckeditor.js')); ?>"></script>

    <script src="<?php echo e(url('admin/js/ckfinder/ckfinder.js')); ?>"></script>

    <script type="text/javascript">
        var baseURL = "<?php echo url('/'); ?>";
    </script>

    <script src="<?php echo e(url('admin/js/func_ckfinder.js')); ?>"></script>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> <?php echo e(Auth::user()->username); ?></a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(URL::route('admin.cate.getList')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Category<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(URL::route('admin.cate.getList')); ?>">List Category</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(URL::route('admin.cate.getAdd')); ?>">Add Category</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(URL::route('admin.product.getList')); ?>">List Product</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(URL::route('admin.product.getAdd')); ?>">Add Product</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(URL::route('admin.user.getList')); ?>">List User</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(URL::route('admin.user.getAdd')); ?>">Add User</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(URL::route('admin.news.getList')); ?>">List Bài Viết</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(URL::route('admin.news.getAdd')); ?>">Add Bài Viết</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
